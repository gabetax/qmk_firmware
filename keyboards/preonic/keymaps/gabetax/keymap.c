...
#define VIM_B ALT_T(KC_LEFT)
// #define VIM_E CMD_T(KC_RIGHT), KC_LEFT
#define VIM_I CMD_T(KC_LEFT)
#define VIM_O CMD_T(KC_RIGHT)
#define VIM_W ALT_T(KC_RIGHT)
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, VIM_W,   _______, _______, _______, _______, VIM_I,   _______, _______, _______, _______,
